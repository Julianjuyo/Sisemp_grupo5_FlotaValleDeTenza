sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prototipo.controller.Incidente", {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("Incidente").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_m_Page_0-content-sap_ui_vbm_GeoMap-1621551020272-vos-sap_ui_vbm_Spots-1",
				"groups": ["items"]
			}];
